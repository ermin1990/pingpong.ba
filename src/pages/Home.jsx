...
const Home = () => {
    ...
    return (
        <div className="min-h-screen bg-[#06090f] text-slate-200 relative overflow-x-hidden font-body antialiased selection:bg-amber-400/30 selection:text-white">
            {/* ── Ambient background ─────────────────────────────── */}
            <div className="fixed inset-0 -z-10 pointer-events-none">
                <div className="absolute top-[-10%] left-1/2 w-[1200px] h-[700px] bg-amber-500/15 rounded-full blur-[150px] animate-aurora" />
                <div className="absolute top-[70%] right-[-10%] w-[800px] h-[560px] bg-lime-400/10 rounded-full blur-[130px] animate-aurora-2" />
                <div className="absolute bottom-0 left-[-5%] w-[700px] h-[450px] bg-amber-500/[0.06] rounded-full blur-[120px]" />
                {/* faint grid */}
                <div
            ...
            <nav className={`fixed top-0 inset-x-0 z-50 transition-all duration-500 ${scrolled ? 'bg-[#06090f]/80 backdrop-blur-xl border-b border-white/[0.06]' : 'bg-transparent border-b border-transparent'}`}>
                <div className="max-w-7xl mx-auto px-5 md:px-8 h-[70px] flex justify-between items-center">
                    ...
                    <div className="flex gap-1.5 md:gap-2 items-center">
                        ...
                        <Link to="/login" className="ml-1 relative inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-semibold text-black bg-gradient-to-r from-amber-300 to-amber-400 hover:from-amber-200 hover:to-amber-300 transition-all shadow-[0_4px_24px_-6px_rgba(251,191,36,0.5)]">
            ...
            <header id="top" className="relative pt-36 md:pt-44 pb-24 px-5 text-center">
                {/* court motif */}
                <svg className="absolute top-24 left-1/2 -translate-x-1/2 w-[min(1150px,95%)] h-[560px] text-lime-300/[0.07] pointer-events-none select-none" viewBox="0 0 800 500" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
                ...
                <div className="relative max-w-5xl mx-auto">
                    <div className="reveal inline-flex items-center gap-2.5 px-4 py-2 mb-9 text-[11px] md:text-xs font-medium tracking-[0.15em] text-amber-200 uppercase bg-amber-500/[0.08] border border-amber-400/20 rounded-full backdrop-blur-sm">
                    ...
                    <h1 className="reveal reveal-delay-1 font-display text-[3.25rem] leading-[0.95] md:text-8xl font-semibold mb-7 tracking-[-0.03em] text-white max-w-4xl mx-auto">
                        Organizuj. Odigraj.
                        <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-300 via-amber-200 to-lime-300">Dominiraj.</span>
                    </h1>
                    ...
                    <div className="reveal reveal-delay-3 flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
                        <button
                            ...
                            className="sheen-parent group w-full sm:w-auto bg-gradient-to-r from-amber-300 to-amber-400 text-black px-9 py-4 rounded-2xl font-semibold hover:from-amber-200 hover:to-amber-300 transition-all shadow-[0_0_50px_-12px_rgba(251,191,36,0.6)] text-base flex items-center justify-center gap-2.5 active:scale-[0.98]"
                        >
                        ...
                        <Link to="/explore" className="group w-full sm:w-auto bg-white/[0.04] text-white border border-white/10 px-9 py-4 rounded-2xl font-medium hover:bg-white/[0.09] hover:border-white/20 transition-all text-base flex items-center justify-center gap-2.5 backdrop-blur-sm active:scale-[0.98]">
                            <Activity size={19} className="text-lime-300" /> Pogledaj takmičenja
                        </Link>
                    </div>
                        ...
                        <div className="relative bg-slate-900/60 border border-white/10 rounded-3xl p-6 backdrop-blur-sm shadow-2xl">
                            ...
                            <div className="grid grid-cols-2 divide-x divide-white/10">
                                <div className="text-center px-3">
                                    ...
                                    <div className="font-display text-5xl md:text-6xl font-bold text-amber-400 tabular-nums">40</div>
                                ...
                                <div className="text-center px-3">
                                    ...
                                    <div className="font-display text-5xl md:text-6xl font-bold text-lime-400 tabular-nums">AD</div>
                        ...
                        <div className="reveal reveal-delay-4 flex flex-wrap justify-center gap-2.5">
                            {['Uživo bodovanje poen-po-poen', 'Automatski žrijeb', 'Parovi za dublove', 'Praćenje meča uživo', 'Korporativne lige'].map((tag, i) => (
                                <div key={i} className="flex items-center gap-2 px-4 py-2 bg-white/[0.04] border border-white/10 rounded-full text-sm text-slate-300">
                                    <CheckCircle2 size={14} className="text-lime-400" /> {tag}
                                </div>
                            ))}
                        </div>
                    )}
            ...
            <section id="trust" className="relative py-20 md:py-24 px-5">
                <div className="max-w-3xl mx-auto reveal">
                    <div className="relative bg-gradient-to-br from-slate-900/80 to-slate-900/30 backdrop-blur-xl border border-white/[0.08] p-7 md:p-9 rounded-3xl overflow-hidden group hover:border-lime-400/25 transition-all duration-500">
                        <div className="absolute -top-16 -right-16 w-40 h-40 bg-lime-400/10 rounded-full blur-3xl group-hover:bg-amber-400/15 transition-all duration-700" />
                        <div className="flex flex-col md:flex-row items-center gap-6 relative z-10">
                            <div className="w-16 h-16 rounded-2xl bg-lime-400/10 flex items-center justify-center flex-shrink-0 border border-lime-400/20">
                                <ShieldCheck size={30} className="text-lime-300" />
                            </div>
                            ...
                            <button
                                onClick={() => setShowForm(true)}
                                className="shrink-0 flex items-center gap-2 text-sm font-semibold text-lime-300 bg-lime-400/10 py-3 px-6 rounded-xl border border-lime-400/20 hover:bg-lime-400/20 transition-all"
                            >
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="max-w-2xl mb-14 reveal">
                        ...
                        <h2 className="font-display text-3xl md:text-5xl font-semibold text-white tracking-[-0.02em] leading-tight mb-5">
                            Sve što turnir traži — <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-300 to-lime-300">na jednom mjestu</span>
                        </h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5">
                        ...
                        <div className="reveal md:col-span-2 md:row-span-2 group relative overflow-hidden rounded-3xl border border-white/[0.08] bg-gradient-to-br from-slate-900/70 to-slate-900/20 p-8 md:p-10 hover:border-lime-400/25 transition-all duration-500">
                            <div className="absolute -top-20 -right-20 w-56 h-56 bg-lime-400/10 rounded-full blur-3xl group-hover:bg-lime-400/20 transition-all duration-700" />
                            <div className="relative z-10">
                                ...
                                <div className="flex items-center gap-3 text-xs text-slate-500 font-display uppercase tracking-widest">
                                    ...
                                    <span className="px-3 py-1.5 rounded-lg bg-lime-400/10 border border-lime-400/20 text-lime-300">Set 1:0</span>
                                </div>
                            </div>
                        </div>
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="text-center max-w-2xl mx-auto mb-14 reveal">
                        ...
                        <h2 className="font-display text-3xl md:text-5xl font-semibold text-white tracking-[-0.02em] leading-tight">
                            Turnir spreman za <span className="text-transparent bg-clip-text bg-gradient-to-r from-lime-300 to-amber-300">tri koraka</span>
                        </h2>
                    </div>
            ...
            <section className="relative py-16 md:py-24 px-5">
                <div className="max-w-6xl mx-auto reveal">
                    <div className="relative bg-gradient-to-br from-lime-950/40 via-slate-900/60 to-slate-900/30 border border-lime-400/15 rounded-[2rem] p-8 md:p-14 overflow-hidden">
                        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-lime-400/10 rounded-full blur-[110px] pointer-events-none" />
                        ...
                        <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5 mb-11">
                            {[
                                ...
                                <div key={idx} className="bg-slate-950/50 border border-white/[0.06] rounded-2xl p-6 hover:border-lime-400/25 transition-all">
                                    <div className="w-11 h-11 rounded-xl bg-lime-400/10 border border-lime-400/20 flex items-center justify-center text-lime-300 mb-4">
                                        {item.icon}
                                    </div>
                        ...
                        <div className="relative z-10 flex justify-center">
                            <button
                                onClick={() => setShowForm(true)}
                                className="sheen-parent group bg-gradient-to-r from-lime-300 to-lime-400 text-black px-9 py-4 rounded-2xl font-semibold hover:from-lime-200 hover:to-lime-300 transition-all shadow-[0_0_45px_-12px_rgba(163,230,53,0.6)] flex items-center justify-center gap-2.5 active:scale-[0.98]"
                            >
                        ...
                        {plans.map((plan, i) => (
                            <div
                                ...
                                className={`reveal reveal-delay-${(i % 4) + 1} relative flex flex-col rounded-3xl p-7 transition-all duration-500 hover:-translate-y-1 ${
                                    plan.popular
                                        ? 'border-2 border-amber-400/50 bg-gradient-to-b from-amber-950/30 to-slate-900/60 shadow-[0_20px_60px_-20px_rgba(251,191,36,0.25)]'
                                        : 'border border-white/[0.08] bg-slate-900/40 hover:border-white/20'
                                }`}
                            >
                                {plan.popular && (
                                    <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-gradient-to-r from-amber-300 to-amber-400 text-black text-[10px] font-bold tracking-[0.15em] uppercase px-4 py-1.5 rounded-full shadow-lg flex items-center gap-1.5">
                                ...
                                <div className="space-y-2.5 mb-5">
                                    <div className="flex items-center gap-3 text-sm text-slate-300">
                                        <div className="p-1.5 bg-lime-400/10 rounded-lg"><Trophy size={14} className="text-lime-300" /></div>
                                        {plan.tournaments}
                                    </div>
                                    <div className="flex items-center gap-3 text-sm text-slate-300">
                                        <div className="p-1.5 bg-lime-400/10 rounded-lg"><Users size={14} className="text-lime-300" /></div>
                                        {plan.categories}
                                    </div>
                                </div>
                                ...
                                <button
                                    ...
                                    className={`w-full py-3.5 rounded-xl font-semibold text-sm transition-all active:scale-[0.98] ${
                                        plan.popular
                                            ? 'bg-gradient-to-r from-amber-300 to-amber-400 hover:from-amber-200 hover:to-amber-300 text-black shadow-lg shadow-amber-500/20'
            ...
            <section className="relative py-16 md:py-24 px-5">
                <div className="max-w-6xl mx-auto reveal">
                    <div className="relative bg-[#0a0f1d]/70 backdrop-blur-xl border border-white/[0.08] rounded-[2rem] p-8 md:p-16 overflow-hidden">
                        <div className="absolute -top-20 -right-20 w-64 h-64 bg-amber-500/10 rounded-full blur-[90px]" />
                        <div className="absolute -bottom-20 -left-20 w-64 h-64 bg-lime-400/10 rounded-full blur-[90px]" />
                        ...
                        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                            <div className="lg:col-span-7 text-left">
                                ...
                                <div className="inline-flex items-center gap-4 bg-slate-900/70 border border-amber-400/25 rounded-2xl p-5">
                                    <div className="w-12 h-12 bg-gradient-to-br from-amber-300 to-amber-500 rounded-xl flex items-center justify-center shadow-lg shadow-amber-900/40 shrink-0">
                                        <ShieldCheck size={26} className="text-black" />
                                    </div>
                                    <div className="text-left">
                                        <div className="text-xs font-semibold text-amber-400 uppercase tracking-widest mb-1">Pristup platformi</div>
                                        <div className="text-slate-200 text-sm font-medium leading-snug">
                                            Aplikacija se dobija na zahtjev — uz <span className="text-amber-400 font-semibold">5 dana besplatnog testiranja</span>.
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="lg:col-span-5 relative">
                                <div className="aspect-square rounded-[2.5rem] bg-gradient-to-br from-amber-400 to-lime-400 p-[1.5px] shadow-2xl">
                                    <div className="w-full h-full bg-[#06090f] rounded-[2.4rem] flex flex-col items-center justify-center p-8 gap-6">
                                        <div className="relative">
                                            <div className="absolute inset-0 bg-amber-400/40 blur-3xl rounded-full" />
                                        ...
                                        <button
                                            onClick={() => setShowForm(true)}
                                            className="w-full py-3.5 bg-white text-black rounded-xl font-semibold hover:bg-amber-50 transition-colors flex items-center justify-center gap-2 group"
                                        >
                                ...
                                <div className="absolute -top-5 -right-3 bg-slate-900/90 border border-white/10 backdrop-blur-xl p-4 rounded-2xl shadow-2xl hidden md:block">
                                    <div className="flex items-center gap-3">
                                        <div className="w-10 h-10 bg-lime-400/15 rounded-xl flex items-center justify-center text-lime-400">
                                            <Wifi size={19} />
                                        </div>
                                        <div className="text-left">
            ...
            <section className="relative py-16 md:py-24 px-5">
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div className="reveal group bg-slate-900/50 backdrop-blur-sm rounded-3xl p-8 md:p-10 border border-amber-400/15 hover:border-amber-400/35 transition-all duration-500">
                            <div className="flex flex-col items-center text-center">
                                <div className="w-20 h-20 bg-gradient-to-br from-amber-300 to-amber-500 rounded-2xl flex items-center justify-center mb-7 group-hover:scale-105 transition-transform duration-500 shadow-xl shadow-amber-500/20">
                                    <Zap size={38} className="text-black" />
                                </div>
                                <h4 className="font-display text-2xl font-semibold text-white mb-1.5">Ermin Selimović</h4>
                                <p className="text-amber-400 font-semibold text-xs mb-5 uppercase tracking-[0.2em]">Dizajn & Razvoj</p>
                                ...
                                <div className="flex flex-wrap justify-center gap-3">
                                    ...
                                    <a href="https://instagram.com/infinitycreative.agency" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-amber-400/10 border border-amber-400/20 hover:border-amber-400/40 px-5 py-2.5 rounded-xl transition-all">
                                        <Users size={17} className="text-amber-400" />
                                        <span className="text-amber-300 text-xs font-semibold uppercase tracking-widest">Instagram</span>
                                    </a>
                                </div>
                            </div>
                        </div>

                        <div className="reveal reveal-delay-1 group bg-slate-900/50 backdrop-blur-sm rounded-3xl p-8 md:p-10 border border-lime-400/15 hover:border-lime-400/35 transition-all duration-500">
                            <div className="flex flex-col items-center text-center">
                                ...
                                <p className="text-lime-400 font-semibold text-xs mb-5 uppercase tracking-[0.2em]">Analiza & Takmičarska Logika</p>
            ...
            <section className="relative py-20 md:py-28 px-5">
                <div className="max-w-4xl mx-auto text-center reveal">
                    <h2 className="font-display text-4xl md:text-6xl font-semibold text-white tracking-[-0.03em] leading-[1.05] mb-6">
                        Spreman za <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-300 to-lime-300">svoj sljedeći turnir</span>?
                    </h2>
                    ...
                    <button
                        onClick={() => setShowForm(true)}
                        className="sheen-parent group bg-gradient-to-r from-amber-300 to-amber-400 text-black px-10 py-5 rounded-2xl font-semibold hover:from-amber-200 hover:to-amber-300 transition-all shadow-[0_0_55px_-12px_rgba(251,191,36,0.6)] text-lg inline-flex items-center justify-center gap-3 active:scale-[0.98]"
                    >
                    ...
                    <div className="w-full max-w-2xl my-auto animate-in fade-in zoom-in-95 duration-300">
                        {!isSuccess ? (
                            <div className="bg-slate-900 border border-white/10 rounded-3xl p-8 md:p-11 shadow-2xl relative overflow-hidden">
                                <div className="absolute -top-24 -right-24 w-56 h-56 bg-amber-500/10 rounded-full blur-3xl" />
                                <div className="relative z-10">
                                    <div className="flex justify-between items-start mb-8">
                                        <div className="flex items-center gap-4">
                                            <div className="w-14 h-14 bg-gradient-to-br from-amber-300 to-amber-500 rounded-2xl flex items-center justify-center shrink-0 shadow-xl shadow-amber-600/20">
                                                ...
                                                <button
                                                    ...
                                                    className={`px-4 py-2 rounded-full text-xs font-semibold border transition-all ${
                                                        requestForm.plan === plan.id
                                                            ? 'bg-gradient-to-r from-amber-300 to-amber-400 text-black border-amber-400'
                                    ...
                                    <form onSubmit={handleSubmitRequest} className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                        ...
                                        <div className="md:col-span-2 pt-1">
                                            <button
                                                ...
                                                className="sheen-parent group w-full bg-gradient-to-r from-amber-300 to-amber-400 hover:from-amber-200 hover:to-amber-300 text-black font-semibold py-4 rounded-xl transition-all shadow-xl shadow-amber-600/30 flex items-center justify-center gap-3 disabled:opacity-50 active:scale-[0.98]"
                                            >
                                                {isSubmitting ? (
...
const SectionEyebrow = ({ icon, children, center = false, variant = 'amber' }) => {
...
const Logo = ({ size = 'md' }) => {
    ...
    return (
        <div className="relative shrink-0">
            ...
            <div className={`relative ${dims} bg-gradient-to-br from-amber-300 to-amber-500 rounded-lg flex items-center justify-center`}>
...
const FeatureCard = ({ icon, title, children, delay = '' }) => (
    <div className={`reveal ${delay} group relative overflow-hidden rounded-3xl border border-white/[0.08] bg-slate-900/40 p-7 hover:border-lime-400/25 hover:bg-slate-900/60 transition-all duration-500`}>
        <div className="w-11 h-11 rounded-xl bg-lime-400/10 border border-lime-400/20 flex items-center justify-center text-lime-300 mb-5 group-hover:scale-105 transition-transform">
            {icon}
        </div>
