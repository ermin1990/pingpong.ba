    ...
    <DashboardLayout title="Lige (Bergerov sistem)">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <h2 className="text-2xl font-bold text-white tracking-tight">Upravljanje Ligama</h2>
        ...
        {loading ? (
          ...
          <div className="text-center py-20 bg-slate-900/30 border-2 border-dashed border-slate-800 rounded-3xl">
            ...
            <h3 className="text-xl font-semibold text-slate-300">Nema kreiranih liga</h3>
              ...
              >
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className={`px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider ${
                    ...
                    league.status === 'completed' ? 'bg-blue-500/10 text-blue-500 border border-blue-500/20' :
                ...
                <div className="mt-6 pt-6 border-t border-slate-800 flex items-center justify-between">
                  ...
                  <div className="flex items-center text-emerald-500 text-xs font-bold group-hover:translate-x-1 transition-transform">
          ...
          <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm">
            <div className="bg-slate-900 border border-slate-800 rounded-3xl w-full max-w-md overflow-hidden shadow-2xl">
              <div className="p-6 border-b border-slate-800 flex justify-between items-center">
                <h3 className="text-xl font-bold text-white">Nova Liga (Berger)</h3>
              ...
              <form onSubmit={handleCreate} className="p-6 space-y-5">
                ...
                <button
                  type="submit"
                  className="w-full py-4 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-xl transition-all shadow-lg shadow-emerald-600/20 active:scale-[0.98]"
                >
                  Kreiraj Ligu
                </button>
              </form>
