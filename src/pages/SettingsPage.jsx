  ...
  return (
    <DashboardLayout title="Postavke">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        {!isSuperAdmin && (
          <div className="bg-slate-100 dark:bg-slate-900/40 border-2 border-slate-300 dark:border-slate-800 rounded-lg p-6 backdrop-blur-xl">
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 bg-slate-200 dark:bg-slate-800 rounded-xl flex items-center justify-center text-slate-500 dark:text-slate-400 shrink-0">
                <Palette size={20} />
              </div>
              <div>
                <h4 className="text-sm font-bold text-slate-700 dark:text-slate-300 mb-1">Tema Aplikacije</h4>
                <p className="text-xs text-slate-500 dark:text-slate-500">
                  <Shield className="inline w-3 h-3 mr-1" />
                  Promjena tema je dostupna samo Super Administratorima. Kontaktirajte vašeg administratora za izmjenu teme.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Profile Section */}
        <div className="bg-slate-900/40 border border-slate-800 rounded-lg p-8 backdrop-blur-xl">
        ...
        <div className="bg-slate-900/40 border border-slate-800 rounded-lg p-8 backdrop-blur-xl">
          ...
          <div className="space-y-6">
             <div className="bg-slate-950/50 border border-slate-800 rounded-lg p-6 flex items-center justify-between">
        ...
        <div className="bg-slate-900/40 border border-slate-800 rounded-lg p-8 backdrop-blur-xl">
          ...
          <div className="bg-gradient-to-br from-slate-800/50 to-slate-950/50 border border-slate-700/50 rounded-lg p-8 relative overflow-hidden">
        ...
        <div className="flex justify-end gap-4">
          <button className="px-8 py-4 rounded-lg text-slate-500 font-black uppercase text-[10px] tracking-widest hover:text-white transition-all">Poništi</button>
          <button className="bg-blue-600 text-white px-10 py-4 rounded-lg font-black uppercase text-[10px] tracking-widest hover:bg-blue-500 transition-all shadow-xl shadow-blue-500/20 flex items-center gap-2">
