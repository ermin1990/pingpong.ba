...
import { LayoutDashboard, Users, Trophy, Settings, LogOut, Menu, X, Shield, ChevronLeft, ChevronRight, User, Sun, Moon, Zap } from 'lucide-react';
...
const DashboardLayout = ({ children, title }) => {
  ...
  const navItems = [
    ...
    { icon: <Zap size={20} className="text-yellow-500" />, label: 'Amaterske Lige', href: '/admin/seasons' },
